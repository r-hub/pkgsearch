...
```
    ...
    #> - "permutation test" ----------------------------------- 1934 packages in 0.017 seconds -
...
```
    ...
    #>  + 2 hours decoder        1.2.2   Decode Coded Variables to Plain Text and the Other W...
    #>  + 4 hours CNVScope       3.0.5   A Versatile Toolkit for Copy Number Variation Relati...
    #>  + 4 hours PRISM.forecast 0.2.0   Penalized Regression with Inferred Seasonality Modul...
    #>  + 4 hours ParallelLogger 1.2.0   Support for Parallel Computation, Logging, and Funct...
    #>  + 4 hours bnma           1.1.1   Bayesian Network Meta-Analysis using 'JAGS'            
    #>  + 4 hours dsm            2.3.0   Density Surface Modelling of Distance Sampling Data    
    ...
    #>  + 4 hours wflo           1.5     Data Set and Helper Functions for Wind Farm Layout O...
    #>  + 4 hours sen2r          1.3.4   Find, Download and Process Sentinel-2 Data
...
```
    ...
    #> - "google" ---------------------------------------------- 133 packages in 0.008 seconds -
    #>   #     package             version by               @ title                             
...
```
    ...
    #> - "colours" --------------------------------------------- 209 packages in 0.007 seconds -
    #>   #     package    version by              @ title                                       
    #>  1  100 crayon     1.3.4   Gábor Csárdi   3y Colored Terminal Output                     
    #>  2   70 colorspace 1.4.1   Achim Zeileis  1y A Toolbox for Manipulating and Assessing ...
    #>  3   64 viridis    0.5.1   Simon Garnier  2y Default Color Maps from 'matplotlib'
...
```
    ...
    #> [90m 1[39m [4m1[24m[4m3[24m824. crayon           222               [4m5[24m[4m0[24m[4m1[24m167
...
```
    ...
    #> - "test http" ------------------------------------------ 6169 packages in 0.016 seconds -
    #>   #     package   version   by                  @ title                                  
...
```
    ...
    #> - "color" ----------------------------------------------- 209 packages in 0.007 seconds -
    #>   #     package      version by                 @ title                                  
    #>   1 100 crayon       1.3.4   Gábor Csárdi      3y Colored Terminal Output                
    #>   2  70 colorspace   1.4.1   Achim Zeileis     1y A Toolbox for Manipulating and Asses...
    #>   3  64 viridis      0.5.1   Simon Garnier     2y Default Color Maps from 'matplotlib'   
...
```
    ...
    #> - "gabor" ------------------------------------------------- 89 packages in 0.01 seconds -
    #>   #     package  version by              @ title                                         
...
```
    ...
    #> - "Gábor" ------------------------------------------------- 89 packages in 0.01 seconds -
    #>   #     package  version by              @ title                                         
    #>  1  100 igraph   1.2.5   Gábor Csárdi   1M Network Analysis and Visualization            
    #>  2   62 crayon   1.3.4   Gábor Csárdi   3y Colored Terminal Output                       
    #>  3   42 cli      2.0.2   Gábor Csárdi   2M Helpers for Developing Command Line Interfaces
