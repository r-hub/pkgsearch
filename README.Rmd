...
`pkgsearch` uses two R-hub web services ([crandb](http://crandb.r-pkg.org) and [search](https://github.com/metacran/search)) that **munge CRAN metadata and let you access it through several lenses**:
