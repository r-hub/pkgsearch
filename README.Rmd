...
`pkgsearch` uses three R-hub web services ([crandb](https://github.com/r-hub/crandb), [cranlogs](https://github.com/r-hub/cranlogs.app) and [search](https://github.com/metacran/search)) that munge CRAN metadata and let you access it through several lenses.
